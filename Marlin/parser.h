...
#define SEEN_TEST(L) TEST32(codebits, LETTER_BIT(L))
  ...
  static bool seen(const char c)
  {
    ...
    const bool b = !!p;
    if (b)
      value_ptr = valid_float(&p[1]) ? &p[1] : (char *)NULL;
    return b;
  }
...
#define SEEN_TEST(L) !!strchr(command_args, L)
  ...
  FORCE_INLINE static float value_linear_units()
  {
    return value_float();
  }
  FORCE_INLINE static float value_axis_units(const AxisEnum a)
  {
    UNUSED(a);
    return value_float();
  }
  FORCE_INLINE static float value_per_axis_unit(const AxisEnum a)
  {
    UNUSED(a);
    return value_float();
  }
  ...
  inline static void set_input_temp_units(TempUnit units)
  {
  ...
  FORCE_INLINE static float value_celsius()
  {
    return value_float();
  }
  ...
  FORCE_INLINE static float value_feedrate()
  {
